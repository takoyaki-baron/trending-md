...
## RSA-260 被分解——除数验证轻而易举,它周围的一切都不是(09-05 13:19,act pass)
...
- **方法仍未披露**(9 月 4 日最好的一手报道):Lu "未披露算法、软件、硬件或运行时长"。推测使用 GNFS——密码学家
  Emmanuel Thomé 估计 RSA-260 约为 RSA-250(约 2,700 核年)成本的 3 倍——未涉及量子计算机(Charles Guillemet),
  此前的纪录用的是 CADO-NFS。
