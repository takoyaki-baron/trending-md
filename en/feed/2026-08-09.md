...
## 1. OpenAI o3 won IOI 2024 gold and an elite Codeforces rating — competitive programming saturated

- **Velocity:** ▮ steady
- **Source:** OpenAI / arXiv · 3,100+ pts · 4h ago
- **Tags:** `openai` `o3` `competitive-programming` `benchmarks`

OpenAI's o3 reasoning model won a **gold medal at IOI 2024** and reached a Codeforces rating "on par with elite human competitors" (reported as 2724, ~99.8th percentile), using RL + dynamic test-time compute rather than hand-crafted pipelines. The "99.8% on IOI 2026" framing that circulated in aggregators is a conflation — 99.8% is the Codeforces percentile, and o3's IOI result is 2024 gold, not a 2026 score.

**Why it matters:** Competitive programming benchmarks are now saturated. The field needs new evaluation paradigms — Codeforces/IOI-level problems no longer differentiate AI from top humans.

> IOI 2024: gold · Codeforces: 2724 (~99.8th percentile, elite)
