...
xhigh 档 18 胜 0 负收官；Claude Fable 以 15 胜 3 负列第三；Grok 4.6 的 low 档与 Haiku 各档
一胜未得，但 Grok 的 xhigh/medium 档各拿下 2 胜与 1 胜。每局成本从约 0.16 美元（Luna/xhigh）到 21.07 美元（Astra/low）不等。
